...
var TerminalMappingMjvp = /*#__PURE__*/function () {
  function TerminalMappingMjvp(api_server_url) {
    ...
    this.containerId = 'tmjs_' + Object(_modules_Tools_js__WEBPACK_IMPORTED_MODULE_4__["generateId"])(); // Default strings and proxy to detect changes
...
var DOMManipulator = /*#__PURE__*/function () {
  ...
  _createClass(DOMManipulator, [{
    ...
    value: function setActiveTerminal(id) {
      ...
      var location = this.TMJS.map.getLocationById(parseInt(id));
    ...
    value: function markerPopUpInfo(e) {
      ...
      if (typeof e.options.terminalId !== 'undefined') {
        ...
        if (location) {
          ...
          return text + " [ ".concat(e.options.terminalId, " ]");
        }
